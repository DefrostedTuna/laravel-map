...
<html>
<head>
    <title>Uptilt Weather Radar</title>
    <meta charset="UTF-8">
...
<body>
<div id="map"></div>
<div class="clock_widget" style="left: initial; right: 5rem;"><span class="date_string"></span><span class="clock_string"></span></div>
<div class="weather_widget" style="left: initial; right: 5em;">
...
<script src="{{ asset('assets/js/google_radar.js') }}"></script>
